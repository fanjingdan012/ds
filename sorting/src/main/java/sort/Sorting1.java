...
public class Sorting1 {
     ...
     * @param j
     */
    public static void quicksort(Comparable[] array, int i, int j) {
     ...
     */
    public static void qsort(Comparable[] array, int oi, int oj) {
     ...
     * @param r
     */
    public static void mergesort1(Comparable[] array, Comparable[] temp, int l, int r) {
        if (l == r) return;
        int mid = (l + r) / 2;
     ...
     * @param r
     */
    public static void mergesort(Comparable[] array, Comparable[] temp, int l, int r) {
        int i, j, k, mid = (l + r) / 2;
        if (l == r) return;
    ...
    private static void inssort(Comparable[] array, int l, int r){
        if(r<=l)
            return;
        Comparable[] array2 = new Comparable[r-l];
